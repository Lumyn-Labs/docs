...
Download from [GitHub Releases](https://github.com/Lumyn-Labs/Releases) or build from source:

```bash
git clone https://github.com/Lumyn-Labs/lumyn-c-sdk.git
cd lumyn-c-sdk && ./scripts/build.sh
```
